 ...
 * - Newsletter signup using direct backend API calls
 * - Optimal performance with proper React patterns
 * - Preserves all existing authentication work
 * - Consistent branding with aclue_text_clean.png
 * - Full newsletter functionality from MaintenanceMode
 *
 * Architecture:
 * - Client component for form handling
 * - Direct backend API integration
 * - Newsletter component with full interactivity
 * - Primary landing page for all users
 */

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { Gift, Mail, CheckCircle, Sparkles, Brain, Zap, Users, Star } from 'lucide-react';
