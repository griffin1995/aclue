 ...
 *
 * Main landing page featuring newsletter signup and maintenance mode content.
 * This is the home page (/) of the aclue platform in maintenance mode.
 *
 * Features:
 ...
 * - App Router metadata API (no next/head usage)
 */

// Page-specific metadata
export const metadata: Metadata = {
  title: 'aclue - AI-powered gifting platform',
  description: 'Our AI-powered platform is learning to understand your unique gift preferences. Experience personalised recommendations that actually understand what you and your loved ones want.',
  openGraph: {
    title: 'aclue - The Future of Gift Discovery',
    description: 'Our AI-powered platform is learning to understand your unique gift preferences.',
  },
}
