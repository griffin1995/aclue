...
function WelcomeEmail({ email, source = 'newsletter' }: WelcomeEmailProps) {
  ...
  const emailStyles = `
    @media (prefers-color-scheme: dark) {
      ...
      .glassmorphism-card { background: #334155 !important; border: 1px solid #475569 !important; }
      .section-divider { border-top: 1px solid #475569 !important; }
      .early-access-badge { background: #334155 !important; border: 1px solid #013370 !important; }
      .footer { color: #e4e4e7 !important; }
      .footer a { color: #013370 !important; }
      .footer div[style*="background: #f8fafc"] { background: #27272a !important; border-color: #475569 !important; }
