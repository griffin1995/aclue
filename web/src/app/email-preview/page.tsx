 ...
 */
function WelcomeEmail({ email, source = 'newsletter' }: WelcomeEmailProps) {
  // SVG logo with responsive sizing for mobile optimisation
  const aclueLogoSvg = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="158.2 172.5 866.8 866.8" style="width: clamp(120px, 25vw, 180px); height: clamp(120px, 25vw, 180px); max-width: 100%; display: block; margin: 0 auto 16px auto; color: #ffffff;">
    ...
    <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: 1.6, color: '#333', margin: 0, padding: 0 }}>
      ...
      <div style={container} className="container">
        ...
        <div style={header} className="header">
          ...
          <h1 style={h1} className="heading heading-text">Welcome to aclue!</h1>
        </div>
        ...
        <div style={content} className="content">
          ...
          <section>
            <p style={leadText} className="lead-text">
              Hello there! I'm delighted you've joined our community of thoughtful gift-givers.
            </p>
          ...
          <section>
            ...
            <p style={text} className="body-text">
              Your subscription is confirmed! You'll receive curated updates about new features,
          ...
          <section>
            ...
            <p style={text} className="body-text">
              ...
              I'll share behind-the-scenes insights, new features as they launch, and exclusive early access opportunities.
            </p>
            <p style={text} className="body-text">
          ...
          {/* Early Access Badge */}
          <div className="early-access-badge" style={earlyAccessBadge}>
            <p style={{ ...text, marginBottom: '8px', fontWeight: '600', color: '#075985' }} className="badge-text">
              ⭐ Early Subscriber
            </p>
            <p style={{ ...text, marginBottom: '0', fontSize: '14px', color: '#52525b' }} className="badge-secondary">
...
// Page component that renders only the clean email template
export default function EmailPreviewPage() {
  return <WelcomeEmail email="preview@example.com" source="newsletter" />
}
