...
export interface SearchHookState {
  ...
  readonly facets: {
    readonly categories: ReadonlyArray<{ readonly name: string; readonly count: number }>;
    readonly brands: ReadonlyArray<{ readonly name: string; readonly count: number }>;
    readonly priceRanges: ReadonlyArray<{ readonly range: string; readonly count: number }>;
  };
  readonly loading: boolean;
  readonly error: ApiErrorDetails | null;
