  ...
  if (stryMutAct_9fa48("12168")) {
    ...
    return <>
      <Head>
        ...
        <meta name="description" content="aclue's accessibility statement detailing our commitment to inclusive design and compliance with WCAG 2.1 AA accessibility standards." />
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-indigo-800">
                  ...
                  <span className="font-medium ml-3">Last Review:</span> {new Date().toLocaleDateString(stryMutAct_9fa48("12169") ? "" : (stryCov_9fa48("12169"), 'en-GB'))} | 
                  <span className="font-medium ml-3">Next Review:</span> {new Date(stryMutAct_9fa48("12170") ? Date.now() - 365 * 24 * 60 * 60 * 1000 : (stryCov_9fa48("12170"), Date.now() + (stryMutAct_9fa48("12171") ? 365 * 24 * 60 * 60 / 1000 : (stryCov_9fa48("12171"), (stryMutAct_9fa48("12172") ? 365 * 24 * 60 / 60 : (stryCov_9fa48("12172"), (stryMutAct_9fa48("12173") ? 365 * 24 / 60 : (stryCov_9fa48("12173"), (stryMutAct_9fa48("12174") ? 365 / 24 : (stryCov_9fa48("12174"), 365 * 24)) * 60)) * 60)) * 1000)))).toLocaleDateString(stryMutAct_9fa48("12175") ? "" : (stryCov_9fa48("12175"), 'en-GB'))}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              This accessibility statement was last updated on {new Date().toLocaleDateString(stryMutAct_9fa48("12176") ? "" : (stryCov_9fa48("12176"), 'en-GB'), stryMutAct_9fa48("12177") ? {} : (stryCov_9fa48("12177"), {
                year: stryMutAct_9fa48("12178") ? "" : (stryCov_9fa48("12178"), 'numeric'),
                month: stryMutAct_9fa48("12179") ? "" : (stryCov_9fa48("12179"), 'long'),
                day: stryMutAct_9fa48("12180") ? "" : (stryCov_9fa48("12180"), 'numeric')
              }))}
            </p>
          </div>
        </div>
