  ...
  if (stryMutAct_9fa48("14402")) {
    ...
    return <>
      <Head>
        ...
        <meta name="description" content="aclue's comprehensive privacy policy outlining how we collect, use, and protect your personal data in compliance with GDPR and UK data protection laws." />
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    ...
                    <a href="https://ico.org.uk/make-a-complaint/" target="_blank" rel="noopener noreferrer" className="text-yellow-700 text-xs underline hover:text-yellow-900">
                      ICO Complaints
                    </a>
                  </div>
                </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              Last updated: {new Date().toLocaleDateString(stryMutAct_9fa48("14403") ? "" : (stryCov_9fa48("14403"), 'en-GB'), stryMutAct_9fa48("14404") ? {} : (stryCov_9fa48("14404"), {
                year: stryMutAct_9fa48("14405") ? "" : (stryCov_9fa48("14405"), 'numeric'),
                month: stryMutAct_9fa48("14406") ? "" : (stryCov_9fa48("14406"), 'long'),
                day: stryMutAct_9fa48("14407") ? "" : (stryCov_9fa48("14407"), 'numeric')
              }))}
            </p>
          </div>
        </div>
