  ...
  if (stryMutAct_9fa48("14408")) {
    ...
    return <>
      <Head>
        ...
        <meta name="description" content="aclue's terms and conditions covering service usage, user rights, consumer protection, and legal compliance under UK and EU law." />
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <section id="privacy-data" className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  <Link href="/privacy" className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              Last updated: {new Date().toLocaleDateString(stryMutAct_9fa48("14409") ? "" : (stryCov_9fa48("14409"), 'en-GB'), stryMutAct_9fa48("14410") ? {} : (stryCov_9fa48("14410"), {
                year: stryMutAct_9fa48("14411") ? "" : (stryCov_9fa48("14411"), 'numeric'),
                month: stryMutAct_9fa48("14412") ? "" : (stryCov_9fa48("14412"), 'long'),
                day: stryMutAct_9fa48("14413") ? "" : (stryCov_9fa48("14413"), 'numeric')
              }))}
            </p>
          </div>
        </div>
