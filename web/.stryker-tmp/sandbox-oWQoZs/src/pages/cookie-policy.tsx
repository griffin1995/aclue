  ...
  if (stryMutAct_9fa48("13359")) {
    ...
    return <>
      <Head>
        ...
        <meta name="description" content="Learn about how aclue uses cookies and tracking technologies to improve your experience and provide personalised gift recommendations." />
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://www.amazon.co.uk/gp/help/customer/display.html?nodeId=201909010" className="text-blue-600 hover:text-blue-800 underline text-sm flex items-center gap-1" target="_blank" rel="noopener noreferrer">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://posthog.com/privacy" className="text-blue-600 hover:text-blue-800 underline text-sm flex items-center gap-1" target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              Last updated: {new Date().toLocaleDateString(stryMutAct_9fa48("13360") ? "" : (stryCov_9fa48("13360"), 'en-GB'), stryMutAct_9fa48("13361") ? {} : (stryCov_9fa48("13361"), {
                year: stryMutAct_9fa48("13362") ? "" : (stryCov_9fa48("13362"), 'numeric'),
                month: stryMutAct_9fa48("13363") ? "" : (stryCov_9fa48("13363"), 'long'),
                day: stryMutAct_9fa48("13364") ? "" : (stryCov_9fa48("13364"), 'numeric')
              }))}
            </p>
          </div>
        </div>
