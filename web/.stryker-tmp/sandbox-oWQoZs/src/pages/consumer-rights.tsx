  ...
  if (stryMutAct_9fa48("13353")) {
    ...
    return <>
      <Head>
        ...
        <meta name="description" content="Learn about your consumer rights when using aclue, including protections under UK Consumer Rights Act 2015 and EU consumer protection law." />
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                  ...
                  <div className="text-sm">
                    <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-green-700 underline hover:text-green-900 flex items-center gap-1">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-center mt-4">
                      <Link href="/affiliate-disclosure" className="text-blue-600 hover:text-blue-800 underline text-sm">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="border border-gray-200 rounded p-3">
                        ...
                        <a href="https://www.citizensadvice.org.uk" className="text-blue-600 text-sm underline hover:text-blue-800 flex items-center gap-1" target="_blank" rel="noopener noreferrer">
                      ...
                      <div className="border border-gray-200 rounded p-3">
                        ...
                        <a href="https://www.gov.uk/find-local-trading-standards-office" className="text-blue-600 text-sm underline hover:text-blue-800 flex items-center gap-1" target="_blank" rel="noopener noreferrer">
                      ...
                      <div className="border border-gray-200 rounded p-3">
                        ...
                        <a href="https://www.gov.uk/government/organisations/competition-and-markets-authority" className="text-blue-600 text-sm underline hover:text-blue-800 flex items-center gap-1" target="_blank" rel="noopener noreferrer">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="border border-gray-200 rounded p-3">
                        ...
                        <a href="https://ec.europa.eu/consumers/odr" className="text-blue-600 text-sm underline hover:text-blue-800 flex items-center gap-1" target="_blank" rel="noopener noreferrer">
                      ...
                      <div className="border border-gray-200 rounded p-3">
                        ...
                        <a href="https://ec.europa.eu/info/live-work-travel-eu/consumer-rights-and-complaints/resolve-your-consumer-complaint/european-consumer-centres-network-ecc-net_en" className="text-blue-600 text-sm underline hover:text-blue-800 flex items-center gap-1" target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              Last updated: {new Date().toLocaleDateString(stryMutAct_9fa48("13354") ? "" : (stryCov_9fa48("13354"), 'en-GB'), stryMutAct_9fa48("13355") ? {} : (stryCov_9fa48("13355"), {
                year: stryMutAct_9fa48("13356") ? "" : (stryCov_9fa48("13356"), 'numeric'),
                month: stryMutAct_9fa48("13357") ? "" : (stryCov_9fa48("13357"), 'long'),
                day: stryMutAct_9fa48("13358") ? "" : (stryCov_9fa48("13358"), 'numeric')
              }))}
            </p>
          </div>
        </div>
