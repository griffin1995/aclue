  ...
  if (stryMutAct_9fa48("13352")) {
    ...
    return <>
      <Head>
        ...
        <meta name="description" content="Join the aclue team and help revolutionise gift-giving with AI. Explore career opportunities in our growing company." />
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border mb-12">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 bg-primary-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-700 transition-colors">
                Get in Touch
                <Users className="w-5 h-5" />
              </Link>
            </div>
