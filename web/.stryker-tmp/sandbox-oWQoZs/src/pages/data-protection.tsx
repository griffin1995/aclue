  ...
  if (stryMutAct_9fa48("13801")) {
    ...
    return <>
      <Head>
        ...
        <meta name="description" content="Learn about your data protection rights under GDPR and UK data protection law, including how to access, correct, delete, or export your personal data from aclue." />
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
                      ...
                      <a href="mailto:privacy@aclue.app" className="text-blue-600 text-sm underline hover:text-blue-800">
                        privacy@aclue.app
                      </a>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-green-50 border border-green-200 p-4 rounded-lg text-center">
                    ...
                    <a href="mailto:privacy@aclue.app" className="inline-block bg-green-600 text-white px-4 py-2 rounded text-sm hover:bg-green-700 transition-colors">
                      privacy@aclue.app
                    </a>
                  </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              Last updated: {new Date().toLocaleDateString(stryMutAct_9fa48("13802") ? "" : (stryCov_9fa48("13802"), 'en-GB'), stryMutAct_9fa48("13803") ? {} : (stryCov_9fa48("13803"), {
                year: stryMutAct_9fa48("13804") ? "" : (stryCov_9fa48("13804"), 'numeric'),
                month: stryMutAct_9fa48("13805") ? "" : (stryCov_9fa48("13805"), 'long'),
                day: stryMutAct_9fa48("13806") ? "" : (stryCov_9fa48("13806"), 'numeric')
              }))}
            </p>
          </div>
        </div>
