...
export default function ServerHeroSection({
  stats
}: HeroSectionProps) {
  if (stryMutAct_9fa48("4016")) {
    ...
    stryCov_9fa48("4016");
    return <section className="relative bg-gradient-to-br from-primary-50 via-white to-secondary-50 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
              Find the{stryMutAct_9fa48("4017") ? "" : (stryCov_9fa48("4017"), ' ')}
              <span className="text-primary-600">perfect gift</span>{stryMutAct_9fa48("4018") ? "" : (stryCov_9fa48("4018"), ' ')}
              with AI
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Link href="/discover" className="inline-flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 transition-colors">
                Try Demo
                <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {stats.map(stryMutAct_9fa48("4019") ? () => undefined : (stryCov_9fa48("4019"), (stat, index) => <div key={stat.label} className="text-center">
